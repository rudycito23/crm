...
import logo from "../images/avoda_logo.png";
      ...
      <div className="w-screen bg-slate-300">
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="col-start-3 m-4 flex justify-end items-center gap-4">
            <button className="flex items-center space-x-2 border-solid border-2 border-sky-500 rounded-lg p-2" data-modal-target="login-modal" data-modal-toggle="login-modal">
